...
# Default to SQLite if Postgres creds are not provided, to allow development to proceed.
# In production or if configured, use Postgres.
...
# Add a sink to stderr with a custom format
if sys.stderr:
    logger.add(
        sys.stderr,
