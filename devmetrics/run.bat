...
cd /d "%~dp0"
echo ============================================
echo   DevMetrics - GitHub Analytics Dashboard
echo ============================================
echo.
...
start "DevMetrics - API" /d "%~dp0backend" cmd /k "go run ./cmd/api/main.go"

timeout /t 3 /nobreak >nul

echo [2/2] Iniciando frontend Next.js (porta 3000)...
start "DevMetrics - Frontend" /d "%~dp0frontend" cmd /k "npm install && npm run dev"
